...
function statusBadgeClass(status: string): string {
  ...
  if (status.includes("補")) return "border-violet-300 bg-violet-50 text-violet-900"
            ...
            <table className="w-full min-w-[640px] border-collapse text-sm">
              <thead>
                <tr className="border-b border-border bg-muted/40 text-left text-muted-foreground">
                  ...
                  <th className="px-3 py-2 font-medium">出席</th>
                  <th className="px-3 py-2 font-medium">缺席</th>
                  <th className="px-3 py-2 font-medium">請假</th>
                  <th className="px-3 py-2 font-medium">補課</th>
                  <th className="px-3 py-2 font-medium">網課</th>
                </tr>
              </thead>
              <tbody>
                {monthAgg.length === 0 ? (
