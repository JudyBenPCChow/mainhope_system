          ...
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-border pb-3">
            ...
            <div className="flex flex-wrap gap-2">
              <Button
                ...
                size="sm"
                variant="secondary"
                className="gap-1 bg-violet-100 text-violet-900 hover:bg-violet-200"
              ...
              <table className="w-full min-w-[720px] border-collapse text-sm">
                <thead>
                  <tr className="border-b border-border bg-muted/40 text-left text-muted-foreground">
                    ...
                    <th className="px-2 py-2 font-medium">學生</th>
                    <th className="px-2 py-2 font-medium">年級</th>
                    <th className="px-2 py-2 font-medium">狀態</th>
                    <th className="px-2 py-2 font-medium">通知</th>
                  </tr>
                </thead>
                <tbody>
