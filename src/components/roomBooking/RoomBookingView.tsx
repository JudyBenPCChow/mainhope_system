                ...
                <table className="w-full min-w-[720px] border-collapse text-xs sm:text-sm">
                  <thead>
                    <tr className="bg-muted/40 text-left text-muted-foreground">
                      <th className="sticky left-0 z-[1] min-w-[7rem] border border-border bg-muted/50 px-2 py-2">
                        時段
                      </th>
                      {weekDays.map((d) => (
                        <th key={d} className="min-w-[6.5rem] border border-border px-1 py-2 font-medium">
