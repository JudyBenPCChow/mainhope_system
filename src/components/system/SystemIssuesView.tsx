        ...
        <table className="w-full min-w-[880px] text-left text-sm">
          <thead className="border-b border-border bg-muted/50 text-muted-foreground">
            <tr>
              ...
              <th className="px-3 py-3 font-medium">嚴重度</th>
              <th className="px-3 py-3 font-medium">用戶</th>
              <th className="px-3 py-3 font-medium">角色</th>
              <th className="px-3 py-3 font-medium">路徑</th>
              <th className="px-3 py-3 font-medium">來源</th>
              <th className="px-3 py-3 font-medium md:px-4">訊息</th>
              <th className="px-3 py-3 font-medium md:px-4">狀態／詳情</th>
            </tr>
          </thead>
