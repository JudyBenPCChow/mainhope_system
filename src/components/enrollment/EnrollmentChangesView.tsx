          ...
          <table className="w-full min-w-[56rem] border-collapse text-sm">
            <thead>
              <tr className="border-b border-border bg-muted/40 text-left text-xs font-medium text-muted-foreground">
                <th className="px-3 py-2 whitespace-nowrap">生效日</th>
                <th className="px-3 py-2 whitespace-nowrap">類型</th>
                <th className="px-3 py-2">學生</th>
                <th className="px-3 py-2">班別</th>
                <th className="px-3 py-2 whitespace-nowrap">老師</th>
                <th className="px-3 py-2">原因／備註</th>
                <th className="px-3 py-2 whitespace-nowrap">建立時間</th>
              </tr>
            </thead>
            <tbody>
              {rows.map((r) => (
                ...
                >
                  <td className="px-3 py-2.5 tabular-nums text-muted-foreground">{r.effectiveDate}</td>
