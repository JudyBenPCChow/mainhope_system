    ...
    <div className="mx-auto max-w-[110rem] space-y-4">
      ...
      <div className="overflow-x-auto rounded-xl border border-border bg-card shadow-sm">
        <table className="w-full min-w-[720px] border-collapse text-left text-xs md:text-sm">
          <thead>
            <tr>
              <th className="sticky left-0 z-10 w-[7.5rem] border-b border-r border-border bg-muted/90 px-2 py-2 font-medium text-muted-foreground">
                節次
              </th>
              {columnDates.map((ymd, i) => (
                <th
                  key={ymd}
                  className="min-w-[7.5rem] border-b border-border bg-muted/60 px-1.5 py-2 text-center font-medium leading-tight"
                >
