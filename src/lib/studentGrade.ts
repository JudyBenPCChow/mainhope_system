...
export const SENIOR_STUDENT_GRADE_CODES = ["S4", "S5", "S6"] as const
...
/** 中四或以上（S4–S6） */
export function isSeniorStudentGrade(raw: string | null | undefined): boolean {
 const code = normalizeStudentGrade(raw)
 return code != null && (SENIOR_STUDENT_GRADE_CODES as readonly string[]).includes(code)
}
