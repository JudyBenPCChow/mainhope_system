...
describe("payroll returnNav", () => {
  ...
  it("builds attendance records path with payroll month and teacher", () => {
    expect(payrollAttendanceRecordsPath({ month: "2026-08", teacherId: "t1" })).toBe(
      "/AttendanceRecords?from=payroll&month=2026-08&teacher=t1"
    )
  })
