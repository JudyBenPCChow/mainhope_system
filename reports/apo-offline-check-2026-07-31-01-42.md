...
- **[howto路徑]** 明日課堂提醒 · 意圖 — 期望 "howto"，得到 "db_query"
- **[howto路徑]** 家長報讀申請 · 姓名抽取 — 期望 null，得到 "家長"
- **[howto路徑]** 家長報讀申請 · 意圖 — 期望 "howto"，得到 "db_query"
- **[howto路徑]** 老師請假處理 · 意圖 — 期望 "howto"，得到 "db_query"
- **[資料查詢抽取]** 霍健一呢 · 姓名 — 期望 "霍健一"，得到 "霍健一呢"
- **[資料查詢抽取]** 學生：梁天因 · 意圖 — 期望 "howto"，得到 "db_query"
- **[路由覆蓋]** 側欄路徑皆在 APO_VALID_PATHS（或僅可解釋例外） — 缺：/Apo, /Settings
...
- ✓ 指派代堂 · 回覆唔准假搜學生 — OK
- ✓ 明日課堂提醒 · 姓名抽取 — 得到 null
- ✗ 明日課堂提醒 · 意圖 — 期望 "howto"，得到 "db_query"
- ✓ 明日課堂提醒 · guideId — 得到 "tomorrow_reminders"
- ✓ 明日課堂提醒 · 回覆唔准假搜學生 — OK
- ✗ 家長報讀申請 · 姓名抽取 — 期望 null，得到 "家長"
- ✗ 家長報讀申請 · 意圖 — 期望 "howto"，得到 "db_query"
- ✓ 家長報讀申請 · guideId — 得到 "portal_enrollment"
- ✓ 家長報讀申請 · 回覆唔准假搜學生 — OK
- ✓ 老師請假處理 · 姓名抽取 — 得到 null
- ✗ 老師請假處理 · 意圖 — 期望 "howto"，得到 "db_query"
...
- ✗ 霍健一呢 · 姓名 — 期望 "霍健一"，得到 "霍健一呢"
- ✓ 霍健一呢 · 意圖 — 得到 "db_query"
- ✓ 霍健一呢 · 應視為學生資料問句或短姓名
- ✓ 學生：梁天因 · 姓名 — 得到 "梁天因"
- ✗ 學生：梁天因 · 意圖 — 期望 "howto"，得到 "db_query"
...
- ✗ 側欄路徑皆在 APO_VALID_PATHS（或僅可解釋例外） — 缺：/Apo, /Settings

### 知識庫健全

- ✓ HOWTO_GUIDES 數量 ≥ 30 — 實際 43
- ✓ guide id 無重複
