...
| --- | --- |
| 日期 | 2026-08-04 |
| 主題／backlog | `docs/product/topics/summer-enrollment-roster-consistency.md` |
...
- 改：`docs/product/BACKLOG.md`、`docs/product/topics/summer-enrollment-roster-consistency.md`
