...
| 收款單一入口鐵則 | `docs/UI_DESIGN_INSTRUCTIONS.md` §15 |
| 繳費收據操作手冊 | `docs/manual/PAYMENT_RECEIPTS.md` |
| 角色營運 audit（RLS gap） | `docs/audits/2026-07-30-role-ops-adversarial.md` P1-5 |
