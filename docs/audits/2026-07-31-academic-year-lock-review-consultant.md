...
```
docs/audits/2026-07-31-academic-year-lock-review.md   ← 團隊檢查報告（本審閱對象）
docs/backlog/academic-year-lock.md                    ← 工程待辦 L1–L15
docs/ACADEMIC_YEARS.md                               ← 學年政策
docs/audits/2026-07-30-role-ops-adversarial.md       ← P0-2 原始發現
