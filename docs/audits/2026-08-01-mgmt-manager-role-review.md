...
> 審查日期：2026-08-01  
> 審查對象：[`docs/plans/2026-08-01-mgmt-manager-role.md`](../plans/2026-08-01-mgmt-manager-role.md)  
...
| D3 | `docs/AGENT_HANDOFF.md` §6 | 加 manager（若有的話） |
| D4 | `docs/BACKLOG.md` | 開工時改 status；完成後移已完成 |
| D5 | `docs/backlog/mgmt-manager-role.md` | 開工時改 status |
