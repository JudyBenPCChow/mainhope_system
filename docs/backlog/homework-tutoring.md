...
| 相關 | [`payroll-engine.md`](./payroll-engine.md)、[`SCHEDULING_RULES.md`](../SCHEDULING_RULES.md) §4、下游員工守則 [`2627-regular-year-ops-guide.md`](./2627-regular-year-ops-guide.md)（補寫指引 **§7 功輔**） |
...
3. **2026-08-11 吸納待決**：H1／H2／H3／H8／H9／H10 已定；H4 後補；H5–H7／H11 仍開。
