...
而家營運文件在 repo `docs/`（如 [`OPS_POLICIES.md`](../OPS_POLICIES.md)、[`manual/TUITION_LATE_FEE_FRONTLINE.md`](../manual/TUITION_LATE_FEE_FRONTLINE.md)），前線要離開系統另開檔。構想：加一頁**應用內目錄＋閱讀**，方便行政以上快速查規條。
...
- 系統說明書：[`SYSTEM_MANUAL.md`](../SYSTEM_MANUAL.md)
