...
試堂（全價／半價／免費）一律經收款登記出學費單並確認後，先增加已繳堂數、先上當日點名紙。未出單或未確認：不增加已繳堂數、不上點名紙。免費一樣出 **$0** 單，堂數填 **1**。半價填正價再加 50% 優惠。計人頭與收款分開，每次手選。詳見 [`TRIAL_RECEIPT_BEFORE_ROSTER.md`](../enrollment/TRIAL_RECEIPT_BEFORE_ROSTER.md)。
