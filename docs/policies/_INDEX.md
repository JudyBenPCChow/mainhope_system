...
| [功課輔導班月費](payments/HOMEWORK_TUTORING_MONTHLY_FEE.md) | 2627 初中按週日數月費；小學跟中一；12／2 月四分三；功輔與專科分單；覆蓋月份＋月數；已繳睇覆蓋月；休學不計月費；缺日數檔顯示未設定；不扣堂、不收專科逾期罰款 |
...
| [同班偶發代堂](scheduling/SCHEDULE_SUBSTITUTE_TEACHER.md) | 代堂 ≠ 更換任教老師；更換任教老師只同步尚未開始的排程 |

### 計糧

| 文件 | 主題 |
| --- | --- |
| [計糧指南](staffing/PAYROLL_GUIDE.md) | 財務／管理層：計法、強積金、出糧、功輔時薪／Christine 功輔佣金；純功輔時薪名單；Natalie 一對一 $350／節（docx → `generated/payroll/`） |
