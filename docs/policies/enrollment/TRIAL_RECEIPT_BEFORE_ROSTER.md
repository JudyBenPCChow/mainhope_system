...
**產品定案：** 2026-08-11  
**系統現況：** **核心已系統化（2026-08-11）**——點名紙 roster 只含已確認收款試堂；免費建立後跳收款；$0 單／堂數 1／計人頭手選／半價＝全價＋50% 優惠已接。餘手冊發佈、阿Po、點名紙人頭標籤見 [`backlog/frontline-ops-update.md`](backlog/frontline-ops-update.md)。
