...
> 狀態：**計劃已定案 · 可開工實作**（本文檔修訂完成；**尚未**寫應用程式）  
...
```
docs/plans/2026-07-31-lifecycle-orphans.md
docs/plans/2026-07-31-lifecycle-orphans-a2-adversarial-self.md
docs/plans/2026-07-31-lifecycle-orphans-review-05.md
docs/plans/2026-07-31-lifecycle-orphans-review-06.md
docs/backlog/lifecycle-orphans.md
