...
閱讀範圍：
1. 方案主檔 `docs/plans/2026-07-31-lifecycle-orphans.md`
2. 分題 backlog `docs/backlog/lifecycle-orphans.md`
3. 相關政策 `docs/ATTENDANCE_BILLING.md`、`docs/manual/LEAVE_MAKEUP_CONSECUTIVE.md`
