...
其後真實申請已核准：張以諾（`20261908`）9/22 中四級常規物理班（`2627-PHYS4001-B`，`16:30–17:45`）已建 `trial_sessions`（已預約／免費／`MX-RC-20260919-0002` $0 已收款）。學生詳情「未來排程」當時只讀就讀中報讀與補堂，故該試堂不出現；已改為納入已確認收款的試堂。
