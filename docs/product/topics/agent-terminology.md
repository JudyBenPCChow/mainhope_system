...
| 立案 | 2026-08-15 |
| 上次更新 | 2026-08-16（員工用語表；同步規則） |

## 結論

F1 **抽離**：三條產品線平排——**專科班**、**私人課程**、**功課輔導班**。F2：禁校方、本校。

- 員工查定義：`docs/meta/TERMINOLOGY.md`
- Agent 用／禁：`.cursor/rules/terminology.mdc`
- 改任何一處必須同步另一處，並審閱 `policies/`、`playbooks/`、2627 `ops-guide.md`
