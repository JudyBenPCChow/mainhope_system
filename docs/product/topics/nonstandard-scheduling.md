...
| 不含 | 常規報讀上紙；班加一格逢星期／加堂排程（`is_extra_lesson`，已報讀生自動上紙）；試堂出單上紙；請假**調堂**掛入另一班現有堂；權益母題 P6 手動加名 UI（見相關） |
...
**討論可即開。** 未拍板前**唔好**改 schema、點名紙入場、或當權益 P6 一併做。
...
權益母題 [`summer-enrollment-roster-consistency.md`](./summer-enrollment-roster-consistency.md) 仍 `in_progress`（餘 P6／`26SM` 日落）。本題**唔等**佢關帳先討論；亦**唔代替** P6。
...
| 名單缺口、要救場上紙 | 權益 **P6 手動加名**（UI 未做） | 補宣告＋原因＋audit；唔當走堂產品 |
...
**現況：** 正規只有開**單堂報讀**（再收款入池）。P6 未做，冇第四條入場。

**待決：** 是否堅持單堂報讀；定另開「走堂一次」；定等 P6 當救場。錢／池／人頭／老師點名紙分別點算。
