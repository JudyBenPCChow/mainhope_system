...
權益母題 [`summer-enrollment-roster-consistency.md`](./summer-enrollment-roster-consistency.md) **已關帳**（2026-08-31：`26SM` 永遠舊路徑、`makeup_of` 留低）。本題**唔等**佢；未拍板前**唔好**改 schema、點名紙入場。
