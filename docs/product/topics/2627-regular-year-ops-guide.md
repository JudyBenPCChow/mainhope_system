...
| 欄位 | 值 |
| --- | --- |
| 狀態 | `open`（**v1.9** md＋docx＋pdf；§11 老師試堂收件匣；§7 編更仍留空；員工發佈／SYSTEM_MANUAL 索引未掛） |
| 優先 | 中 |
| 範圍 | `2627`（2026-09-01 → 2027-06-30）常規學年全公司員工守則（繁中書面語、可列印） |
| 不含 | 技術實作、給 AI 指示、暑期兩期制全文、計糧全文、機構稱呼專章、每周課表、個別老師名單 |
| 產物 | [`ops-guide.md`](../year/2627/ops-guide.md)（**v1.9**／2026-08-17）；[`2627_REGULAR_YEAR_OPS_GUIDE.docx`](../generated/2627/2627_REGULAR_YEAR_OPS_GUIDE.docx)／[`.pdf`](../generated/2627/2627_REGULAR_YEAR_OPS_GUIDE.pdf) |
