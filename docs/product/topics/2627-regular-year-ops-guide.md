...
| 欄位 | 值 |
| --- | --- |
| 狀態 | `done`（2026-08-30 工程關帳：v1.14 md＋docx／pdf；playbooks 已掛。WhatsApp／列印發佈屬營運） |
| 優先 | 中 |
| 範圍 | `2627`（2026-09-01 → 2027-06-30）常規學年全公司員工守則（繁中書面語、可列印） |
| 不含 | 技術實作、給 AI 指示、暑期兩期制全文、計糧全文、機構稱呼專章、每周課表、個別老師名單 |
| 產物 | [`ops-guide.md`](../year/2627/ops-guide.md)（**v1.20**／2026-09-01）；[`2627_REGULAR_YEAR_OPS_GUIDE.docx`](../generated/2627/2627_REGULAR_YEAR_OPS_GUIDE.docx)／[`.pdf`](../generated/2627/2627_REGULAR_YEAR_OPS_GUIDE.pdf) |
...
**v1.20（2026-09-01）：** §2.3 新增報讀班別名單只顯示本學年（2627），不含已結束的 26SM。docx 已重出。

**v1.19（2026-08-31）：** §2.1 查閱 26SM 仍按當時報讀期數，不與本學年已繳堂數混用。docx 已重出。

**v1.18（2026-08-31）：** §4／§7 功輔預設一室 17D；加開第二室先佔。docx 已重出。

**v1.17（2026-08-31）：** §7.4 功輔排更時段默認跟報更（可改）；一日可多人；唔使全日每個時段都有導師。docx 已重出。

**v1.16（2026-08-31）：** §9 點名紙不准手動加名。docx 已重出。

**v1.15（2026-08-31）：** §7.3 功輔月費須與專科分單；填覆蓋月份與月數。

**v1.14（2026-08-29）：** §2.6 標已畢業前確認（未清繳費／待補／請假；可強制）＋設定關閉日常名單收窄。docx 已重出。

**v1.13（2026-08-29）：** §2.6 補堂數對帳日常窗、繳費紀錄預設窗與核數匯出全部。docx 已重出。
...
員工以 WhatsApp／列印發佈；`OPS_POLICIES` 已有政策姊妹篇。**2026-08-29：** [`playbooks/_INDEX.md`](../../playbooks/_INDEX.md)「本學年員工讀本」**已掛** md／pdf／docx（目錄簡介仍寫 v1.11，正文已 v1.14）。
...
| 2 學年與報讀 | 已寫；學年定位併入封面；v1.13 §2.6 日常名單／對帳／繳費匯出 |
...
| repo 索引 | `OPS_POLICIES` 已掛校曆政策；**`playbooks/_INDEX` 已掛本指引**（簡介版本號待改 v1.14） |
| 課表／老師 | 不載每周課表；不列個別老師 |
...
工程已關帳。營運可 WhatsApp／列印發佈（見 [`PUBLISH_CHECKLIST.md`](../../year/2627/PUBLISH_CHECKLIST.md)）。WIP 可刪：[`2627-regular-year-ops-guide-decisions-wip.md`](./2627-regular-year-ops-guide-decisions-wip.md)。
