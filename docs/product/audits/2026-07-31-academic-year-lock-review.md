...
```
docs/product/topics/academic-year-lock.md          ← 工程待辦主檔（L1–L15）
docs/product/BACKLOG.md                            ← 主題索引「學年鎖整固」
docs/product/topics/role-ops-hardening.md         ← P0-2 = moved；主題 done
docs/product/audits/2026-07-30-role-ops-adversarial.md
