...
標題：**當前副頁名稱**（較大字＋icon）｜功課輔導班｜{學年}學年｜{月份}
左側：功課輔導班副頁清單（預覽正式側欄；窄屏改「頁面」選單）
其右：該頁內容（唔用頁內標籤）
```

正式產品：各副頁獨立路由，掛 `navStructure` 一級 **「功課輔導」**（打開後見二級）；**唔用頁內標籤 menu**。

---

## 3. 行政／外星人 — 工作台

分頁 → **側欄項目**：概覽｜報讀學生｜月費｜當值編更｜功輔校曆｜設定
...
- **唔喺本頁新增學生／報讀。** 新學生：學生管理「新增學生」。已註冊：學生詳細頁「報讀班別」加入功課輔導班，再選日數檔＋逢星期幾。本頁 CTA 前往學生管理。
...
分頁 → **側欄項目**：監督首屏｜本月當值｜報更進度｜月費異常｜老師入口

- **首屏**：報更齊交率、未繳人數、當值覆蓋、關注項（少表單）
- **本月當值**：全員月曆唯讀為主
- **報更進度**：列表；不以代填為主 CTA
- **月費異常**：未繳名單
- **老師入口**：剔選哪些專科老師可在系統側欄進入功課輔導班；未剔選者側欄不顯示。沙盒可切老師驗證。
- 可切角色至「行政」看完整工作台（沙盒）
...
- 截止提示（示範：上月 25 日）
- 儲存草稿｜提交｜撤回修改
- 不顯示「不是老師檔期規劃專科頁」或「老師只須報一次更、中／小學由行政分配」等說明字眼
