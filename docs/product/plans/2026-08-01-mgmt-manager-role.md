...
- `docs/meta/TERMINOLOGY.md`、`AGENTS.md`、`docs/meta/AGENT_HANDOFF.md` §6：四角色
- `docs/product/audits/2026-08-01-mgmt-manager-role-review.md`：在計劃中加連結
...
| D3 | `docs/meta/AGENT_HANDOFF.md` §6 | 加 manager |
| D4 | `docs/product/BACKLOG.md` | 開工改 status；完成移已完成 |
| D5 | `docs/product/topics/mgmt-manager-role.md` | 同步更新；加硬規則摘要；連審查報告 |
...
| 用途 | 路徑 |
| --- | --- |
| 產品定案／矩陣摘要 | [`docs/product/topics/mgmt-manager-role.md`](../backlog/mgmt-manager-role.md) |
| 顧問審查報告（紅黃項、完整 checklist） | [`docs/product/audits/2026-08-01-mgmt-manager-role-review.md`](../audits/2026-08-01-mgmt-manager-role-review.md) |
| Backlog 索引列 | [`docs/product/BACKLOG.md`](../BACKLOG.md) |
