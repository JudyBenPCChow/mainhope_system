...
| 狀態 | 優先 | 主題 | 摘要 | 詳情 |
| --- | --- | --- | --- | --- |
| in_progress | 高 | 技術債／工程硬化 | **P0-1** kernel 已喺 production。Staging domain 1–7＋延後表／session／波 5 其餘表／actor 蓋印（authz_version 10）已過 allow-deny。未套 production。**P0-2** Auth 改讀 profile v2（進行中；唔改 nav）。 | [tech-debt-hardening.md](./topics/tech-debt-hardening.md) · [稽核](./audits/2026-08-14-tech-debt-review.md) · [P0-1 重評](./topics/p0-1-authorization-redesign.md) |
