...
| 狀態 | 優先 | 主題 | 摘要 | 詳情 |
| --- | --- | --- | --- | --- |
| in_progress | 高 | 技術債／工程硬化 | **P0-1** production RLS 已套（`authz_version=10`）。**P0-2 已入 main**（2026-08-20 PR #21）：Auth `can()`／路由 `RequireCapabilities`／老師 scope。頁內 `RequireMgmtRoles` 仍暫留；收斂見 `feat/p0-2-capability-only-pages`（未合）。側欄唔改（IA1）。餘可選真人畫面／雙裝置；登出未清 session 角色列；阿Po 仍跟帳戶帽。 | [tech-debt-hardening.md](./topics/tech-debt-hardening.md) · [稽核](./audits/2026-08-14-tech-debt-review.md) · [P0-1 重評](./topics/p0-1-authorization-redesign.md) · [功能×角色](./topics/p0-1-authz-feature-roles.md) |
...
| open | 高 | 2627 九月常規時間表 | 2026-08-20 **ver. 3.4** 候選（63 班；加 Liam Lai／Leo Chan 班別時間鎖定；Cyndi Ng／Emma Cai 維持鎖定；md 審閱稿，Word／PDF 未出）；3.3 及更早檔案保留；待簽收；prod 仍 0 班 | [2627-september-timetable.md](./topics/2627-september-timetable.md) · [方案 md](../year/2627/timetable/versions/v3.4/2627_timetable_scheme_v3.4.md) · [老師 md](../year/2627/timetable/versions/v3.4/2627_timetable_teachers_week_v3.4.md) · [周時間表 md](../year/2627/timetable/versions/v3.4/2627_timetable_weekly_v3.4.md) · [排課規則](../policies/scheduling/SCHEDULING_RULES.md) |
