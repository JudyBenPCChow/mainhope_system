...
| in_progress | 中 | 計糧引擎 | 規格／指南已齊；**UI 預覽** `/Payroll`（財務工作台／管理層核實台 mock）；引擎暫等 Mark Yu；功課班暫緩 | [payroll-engine.md](./backlog/payroll-engine.md) · [指南](./PAYROLL_GUIDE.md) · [修訂方法](./plans/2026-08-01-payroll-method-revised.md) |
