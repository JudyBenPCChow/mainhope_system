...
| 狀態 | 優先 | 主題 | 摘要 | 詳情 |
| --- | --- | --- | --- | --- |
| in_progress | 高 | 報讀包裝與點名權益 | Wave 1–2 ✅；**主波支付→池 ✅**（空池＋top_up／clawback／建議／停轉結餘）；**live `2627` E2E 仍阻**；下一：G2 更正頁／G3／轉科頁 | [summer-enrollment-roster-consistency.md](./backlog/summer-enrollment-roster-consistency.md) · [計劃](./plans/2026-08-04-enrollment-entitlement-roster.md) · [閉環 draft](./plans/2026-08-04-tuition-entitlement-closed-loop.md) · [請假遲用討論](./plans/2026-08-05-leave-deferral-pool-vs-credit-discussion.md) · [顧問評審](./backlog/summer-enrollment-roster-consistency-consulting-review.md) · [影響模擬](./audits/2026-08-03-summer-enrollment-tuition-rights-impact.md) |
| open | 高 | 單據／權益更正頁（G2） | **核心已上**：`/PaymentCorrection`＋池調動表＋作廢 30 分／第二人；餘阿Po／政策全文同步 | [payment-entitlement-correction-ui.md](./backlog/payment-entitlement-correction-ui.md) · [母題 §4.13](./backlog/summer-enrollment-roster-consistency.md) |
| in_progress | 高 | 前台規模／流程更新（試堂原則） | **核心工程已上**：出單閘紙／免費跳收款／$0／計人頭／半價50%；餘 manual／阿Po／2627§11 | [frontline-ops-update.md](./backlog/frontline-ops-update.md) · [試堂 WIP](./backlog/trial-promo-receipt-frontline-wip.md) · [政策](./TRIAL_RECEIPT_BEFORE_ROSTER.md) |
| open | 中 | 營運總覽 KPI 規格 | 寫清 `/MgmtDashboard` 要顯示邊啲數；已收產品 1–7（收學費／堂數／試堂／免費／消堂） | [mgmt-dashboard-kpi-spec.md](./backlog/mgmt-dashboard-kpi-spec.md) |
...
| open | 高 | 2627 九月常規時間表 | 規則已增補；2026-08-08 docx／pdf 候選（36 班、無 TBD）待簽收；prod 仍 0 班；餘缺口＋錄入 | [2627-september-timetable.md](./backlog/2627-september-timetable.md) · [docx](./reports/2627_timetable_scheme_2026-08-08.docx) · [pdf](./reports/2627_timetable_scheme_2026-08-08.pdf) · [排課規則](./SCHEDULING_RULES.md) |
| open | 中 | 2627 常規學年營運指引 | v1.0＋列印 docx 已出；待審閱；索引未掛；**§11 試堂舊句待跟**出單先上紙；職員發佈 | [2627-regular-year-ops-guide.md](./backlog/2627-regular-year-ops-guide.md) · [指引](./manual/2627_REGULAR_YEAR_OPS_GUIDE.md) · [docx](./manual/2627_REGULAR_YEAR_OPS_GUIDE.docx) |
| open | 中 | 功課輔導班產品 | H1–H3／H8–H10 已定；§4＋沙盒已跟 17D／17:00；餘 H5–H7 價曆、H4 讓房、H11 審閱；未接 DB | [homework-tutoring.md](./backlog/homework-tutoring.md) · [待決 WIP](./backlog/homework-tutoring-decisions-wip.md) · [UI v2](./plans/2026-08-01-homework-tutoring-ui-design-v2-roles.md) |
...
| in_progress | 中 | HK 成本統計／入帳 | 7 月：計糧已結算＋`payroll_settle` 已過帳；歷史薪金已 void；Cody 非計糧 $420 已補；**剩按金待定**；非老師人工未產品化；4–6 月／純利另波 | [hk-expense-cost-stats.md](./backlog/hk-expense-cost-stats.md) · [計劃](./plans/2026-08-05-hk-expense-cost-stats.md) |
...
| 狀態 | 優先 | 主題 | 摘要 | 詳情 |
| --- | --- | --- | --- | --- |
| cancelled | 中 | 原班連堂分節點名 | 實務幾乎唔會半節假／半節到；維持整組同一狀態 | [consecutive-half-session-attendance.md](./backlog/consecutive-half-session-attendance.md) |
