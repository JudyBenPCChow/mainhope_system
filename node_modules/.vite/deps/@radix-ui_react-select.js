...
function useSize(element) {
  const [size4, setSize] = React6.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
var Select = (props) => {
  ...
  const [nativeOptionsSet, setNativeOptionsSet] = React11.useState(/* @__PURE__ */ new Set());
...
var SelectTrigger = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React11.useRef("touch");
...
var SelectContentImpl = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    const [selectedItemText, setSelectedItemText] = React11.useState(
      null
    );
    const getItems = useCollection(__scopeSelect);
    ...
    const handleItemLeave = React11.useCallback(() => content == null ? void 0 : content.focus(), [content]);
    ...
    return (0, import_jsx_runtime9.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime9.jsx)(Combination_default, { as: Slot3, allowPinchZoom: true, children: (0, import_jsx_runtime9.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectItemAlignedPosition = React11.forwardRef((props, forwardedRef) => {
...
var SelectPopperPosition = React11.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectScrollUpButton = React11.forwardRef((props, forwardedRef) => {
...
var SelectScrollDownButton = React11.forwardRef((props, forwardedRef) => {
...
var SelectScrollButtonImpl = React11.forwardRef((props, forwardedRef) => {
...
var SelectBubbleInput = React11.forwardRef(
