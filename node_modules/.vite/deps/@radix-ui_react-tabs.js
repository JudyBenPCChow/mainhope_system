...
// node_modules/@radix-ui/react-roving-focus/node_modules/@radix-ui/react-use-effect-event/dist/index.mjs
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React13.useState(_isHydrated);
  React13.useEffect(() => {
    if (!_isHydrated) {
      _isHydrated = true;
      setIsHydrated(true);
...
var useReactSyncExternalStore = React24[" useSyncExternalStore ".trim().toString()];
function subscribe() {
  return () => {
  };
}
...
var useLayoutEffect22 = (globalThis == null ? void 0 : globalThis.document) ? React15.useLayoutEffect : () => {
};
...
function usePresence(present) {
  ...
  const mountAnimationNameRef = React25.useRef(void 0);
...
var SLOTTABLE_IDENTIFIER2 = Symbol.for("radix.slottable");
...
var use2 = React18[" use ".trim().toString()];
...
var DirectionContext2 = React20.createContext(void 0);
function useDirection2(localDir) {
  const globalDir = React20.useContext(DirectionContext2);
  return localDir || globalDir || "ltr";
}
...
// node_modules/@radix-ui/react-tabs/node_modules/@radix-ui/react-use-effect-event/dist/index.mjs
var React21 = __toESM(require_react(), 1);
var useReactEffectEvent2 = React21[" useEffectEvent ".trim().toString()];
var useReactInsertionEffect2 = React21[" useInsertionEffect ".trim().toString()];

// node_modules/@radix-ui/react-tabs/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect2 = React26[" useInsertionEffect ".trim().toString()] || useLayoutEffect22;
...
var useReactId2 = React28[" useId ".trim().toString()] || (() => void 0);
var count2 = 0;
function useId2(deterministicId) {
  const [id, setId] = React28.useState(useReactId2());
  useLayoutEffect22(() => {
...
var TabsContent = React29.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime10.jsx)(Presence, { present: forceMount || isSelected, children: ({ present }) => (0, import_jsx_runtime10.jsx)(
      Primitive2.div,
      {
        "data-state": isSelected ? "active" : "inactive",
        "data-orientation": context.orientation,
